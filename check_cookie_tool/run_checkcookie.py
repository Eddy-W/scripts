...
def load_create_sqls(pars):
	...
	for i in (0,1):
		...
		from
			%s
		where
			product = '%s' and sawLog_.vsolutionid_ = '%s' and %s
		group by sawLog_.rawLog_.ip_ , 
			 sawLog_.rawLog_.allyesid_ , 
			 sawLog_.vsolutionid_ , 
			 sawLog_.regionid_ , 
			 sawLog_.osid_ , 
			 sawLog_.browserid_ , 
